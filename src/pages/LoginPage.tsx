    ...
    <div className="min-h-full flex items-center justify-center p-6 bg-primary">
      ...
      >
        <div className="mb-10 text-center">
          <h2 className="text-4xl font-black tracking-tighter mb-2 font-serif text-secondary uppercase">Portal Access</h2>
          <p className="text-[10px] font-sans font-bold uppercase tracking-[0.3em] opacity-40 text-secondary">Level 01 Security Authorization</p>
        </div>

        {error && (
          <div className="bg-accent/10 border border-accent/20 text-accent p-4 text-[11px] font-bold uppercase tracking-widest mb-8 text-center">
            {error}
          </div>
        )}
