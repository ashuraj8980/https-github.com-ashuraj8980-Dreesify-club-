...
import { Truck, ShieldCheck, CreditCard, ChevronLeft, ShoppingBag, CheckCircle2, AlertCircle, ArrowRight } from 'lucide-react';
...
const CheckoutPage = () => {
  ...
  const handleOnlinePayment = async () => {
    ...
    const options = {
      key: import.meta.env.VITE_RAZORPAY_KEY_ID || "rzp_test_your_test_key", // Replace with real key in production
